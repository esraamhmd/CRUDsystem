        ...
        <div className="flex gap-3">
          {['title', 'category'].map(m => (
            <button
              ...
              className={`btn-sh relative overflow-hidden flex-1 h-10 rounded-full text-xs font-bold text-white border cursor-pointer transition-all duration-250 hover:bg-bs-gradh hover:shadow-bsh hover:-translate-y-0.5 hover:scale-102 active:scale-95 ${searchMode === m ? 'bg-bs-gradh' : 'bg-bs-grad'}`}
              style={{ borderColor: '#1D546D' }}
            >
