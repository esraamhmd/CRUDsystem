...
### A full-featured, responsive product management system built from scratch with React, Vite, and Tailwind CSS v4.
<br/>

<br/>

<!-- Replace this with your own screenshot -->
<!-- <img width="1918" height="907" alt="preview" src="YOUR_SCREENSHOT_URL" /> -->
...
This project was built entirely from scratch with no UI component libraries. Every button, card, input, table, and animation was hand-coded using React and Tailwind CSS v4.

### What makes this project different from tutorial projects?

| Typical Tutorial Project | CRUD App |
|--------------------------|----------|
| Plain HTML / CSS | ✅ React + Vite + Tailwind CSS v4 |
| No animations | ✅ Lottie animations + CSS keyframe animations |
| No dark / light mode | ✅ Full dark / light mode toggle |
| No data persistence | ✅ localStorage persistence across sessions |
| Basic buttons | ✅ Gradient buttons with glow shadows and hover effects |
| No font customization | ✅ Local IosevkaCharon font loaded from project files |
| Emoji icons | ✅ Custom PNG icons for edit and delete actions |
...
### ⚡ Vite 8
Vite provides instant dev server startup and lightning-fast hot module replacement. Build times are under 3 seconds.
